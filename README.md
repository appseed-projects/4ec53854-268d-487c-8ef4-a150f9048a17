...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-15 17:02`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/4ec53854-268d-487c-8ef4-a150f9048a17.git
$ cd 4ec53854-268d-487c-8ef4-a150f9048a17
```
